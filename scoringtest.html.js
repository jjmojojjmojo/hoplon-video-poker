// boot-cljs shim
(function() {
  var shimRegex = new RegExp('(.*)scoringtest.html.js$');
  ...
  writeScript("<script src='" + prefix + "boot-cljs-scoringtest.html.js'></script>");
  writeScript("<script>goog.require('boot.cljs.scoringtest.html');</script>");
