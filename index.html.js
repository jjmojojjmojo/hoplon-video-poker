// boot-cljs shim
(function() {
  var shimRegex = new RegExp('(.*)index.html.js$');
  ...
  writeScript("<script src='" + prefix + "boot-cljs-index.html.js'></script>");
  writeScript("<script>goog.require('boot.cljs.index.html');</script>");
