...
return cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.call(null,((function (suit_code){
return (function (v){
...
return cljs.core.conj.call(null,hearts,spades,diamonds,clubs);
});
video_poker.core.discarded = tailrecursion.javelin.cell.call(null,cljs.core.PersistentVector.EMPTY);
video_poker.core.available = tailrecursion.javelin.cell.call(null,video_poker.core.deck.call(null));
/**
...
return cljs.core.reset_BANG_.call(null,video_poker.core.available,video_poker.core.deck.call(null));
});
