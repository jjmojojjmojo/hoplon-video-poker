// boot-cljs shim
(function() {
  var shimRegex = new RegExp('(.*)display.html.js$');
  ...
  writeScript("<script src='" + prefix + "boot-cljs-display.html.js'></script>");
  writeScript("<script>goog.require('boot.cljs.display.html');</script>");
